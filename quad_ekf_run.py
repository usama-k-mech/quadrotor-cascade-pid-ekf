...
# Windows consoles default to cp1252, which cannot encode the sigma and
# box-drawing characters in the printouts. Force UTF-8 where supported.
...
config = {
    ...
    'quad': {
        ...
        'l'  : 0.225,
        'kT' : 2.98e-6,
        'kQ' : 1.14e-7,   # rotor torque coefficient [N.m/(rad/s)^2]
                          # (Luukkonen b; kQ/kT = 0.0382)
        'Ixx': 4.856e-3,
        'Iyy': 4.856e-3,
        'Izz': 8.801e-3,
        'Ax' : 0.30,
